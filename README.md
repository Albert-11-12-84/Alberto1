...
- **Cuadernos autocontenidos:** La mayoría de las clases están contenidas en un archivo `.ipynb` (mejor conocido como jupyter notebook o simplemente notebook) listo para ejecutar.olhiklhlkhlk
